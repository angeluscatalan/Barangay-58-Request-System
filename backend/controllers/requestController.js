...
const backupRequest = async (requestData) => {
  try {
    // Get all fields from the request including new columns
    const {
      last_name,
      first_name,
      middle_name,
...
exports.createRequest = async (req, res) => {
  ...
  try {
    ...
    // Return the complete request data including the ID
...
exports.restoreRequests = async (req, res) => {
  ...
  try {
    ...
    for (const id of requestIds) {
      ...
      // Insert into main requests table with all fields including new columns
